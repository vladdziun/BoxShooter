...
public class GameManager : MonoBehaviour {
	...
	void EndGame() {
		...
		GameObject.Find("ShotsValue").GetComponent<Text>().text = shotsFired.ToString();
		GameObject.Find("HitsValue").GetComponent<Text>().text = hits.ToString();
		GameObject.Find("AccuracyValue").GetComponent<Text>().text = (hits / shotsFired * 100).ToString("0.0") + "%";
